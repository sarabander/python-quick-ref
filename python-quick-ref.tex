...
\py{chr}{i}
\py{classmethod}{fn}
%\py{compile}{source,\,filename,\,mode,\,flags=0,\,dont\_inherit=False}
...
\py{object}{}
\py{oct}{number}
%\py{open}{file,\,mode=’r’,\,buffering=None,\,encoding=None,\,errors=None,\,newline=None,\,closefd=True}
\py{ord}{c}
\py{pow}{x,\,y,\,[z]}
%print([object,\,...],\,*,\,sep=’ ’,\,end=’\n’,\,file=sys.stdout)
%\py{property}{fget=None,\,fset=None,\,fdel=None,\,doc=None}
